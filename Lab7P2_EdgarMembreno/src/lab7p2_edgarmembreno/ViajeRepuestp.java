...
public class ViajeRepuestp {
    ...
    public ViajeRepuestp(JProgressBar progBar, naves nave, int po, boolean avanzar, boolean vive) {
    ...
    ViajeRepuestp(JProgressBar progress_Distancia) {
